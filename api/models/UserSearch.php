...
/**
 * UserSearch represents the model behind the search form of `api\models\User`.
 */
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'gender', 'city_id', 'register_ip', 'last_login_ip', 'status', 'os', 'login_time', 'active', 'conceal_hide', 'huanxin_created', 'huanxin_modified', 'huanxin_activated'], 'integer'],
    ...
    public function scenarios()
    {
        ...
        $scenarios['update'] = [
            'nick_name', 'wechat_token', 'qq_token', 'avatar_image', 'mobile', 'gender'
        ];
        return $scenarios;
    }
