 ...
 */
class InterestTypeController extends CommonController
{
    public $modelClass = '';
     ...
     * @param integer $id
     * @return InterestTypeModel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = InterestTypeModel::findOne($id)) !== null) {
            return $model;
        }
