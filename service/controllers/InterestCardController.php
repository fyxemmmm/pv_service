 ...
 */
class InterestCardController extends CommonController
{
    public $modelClass = '';
...
//        $this->findModel($id)->delete();
     ...
     * @param integer $id
     * @return InterestCardModel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = InterestCardModel::findOne($id)) !== null) {
            return $model;
        }
